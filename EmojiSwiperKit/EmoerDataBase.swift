...
public class EmoerDataBase {
    public init(){}
    public lazy var persistentContainer: NSPersistentContainer = {
        var applicationDocumentsDirectory = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier:"group.3RAAM9MRX4.20170427.EmojiSwiper")!
         ...
         */
        let container = NSPersistentContainer(name: "EmojiSwiper")
