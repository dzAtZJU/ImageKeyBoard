...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        if userDefaults.object(forKey: "firstLaunch") == nil {
            userDefaults.set(false, forKey: "firstLaunch")
            userDefaults.synchronize()
            emojisDataModel.addDefaultEmojiGroups()
        }
    ...
    let emojisDataModel = EmojisDataModel.myEmojisDataModel()
    var persistentContainer: NSPersistentContainer {
        get {
            return emojisDataModel.persistentContainer!
        }
    }
